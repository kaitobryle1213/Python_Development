CREATE DATABASE  IF NOT EXISTS `paymentschedule_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `paymentschedule_db`;
...
INSERT INTO `auth_permission` VALUES (1,'Can add log entry',1,'add_logentry'),(2,'Can change log entry',1,'change_logentry'),(3,'Can delete log entry',1,'delete_logentry'),(4,'Can view log entry',1,'view_logentry'),(5,'Can add permission',3,'add_permission'),(6,'Can change permission',3,'change_permission'),(7,'Can delete permission',3,'delete_permission'),(8,'Can view permission',3,'view_permission'),(9,'Can add group',2,'add_group'),(10,'Can change group',2,'change_group'),(11,'Can delete group',2,'delete_group'),(12,'Can view group',2,'view_group'),(13,'Can add content type',4,'add_contenttype'),(14,'Can change content type',4,'change_contenttype'),(15,'Can delete content type',4,'delete_contenttype'),(16,'Can view content type',4,'view_contenttype'),(17,'Can add session',5,'add_session'),(18,'Can change session',5,'change_session'),(19,'Can delete session',5,'delete_session'),(20,'Can view session',5,'view_session'),(21,'Can add customer',7,'add_customer'),(22,'Can change customer',7,'change_customer'),(23,'Can delete customer',7,'delete_customer'),(24,'Can view customer',7,'view_customer'),(25,'Can add payment',8,'add_payment'),(26,'Can change payment',8,'change_payment'),(27,'Can delete payment',8,'delete_payment'),(28,'Can view payment',8,'view_payment'),(29,'Can add user',6,'add_boardinghouseuser'),(30,'Can change user',6,'change_boardinghouseuser'),(31,'Can delete user',6,'delete_boardinghouseuser'),(32,'Can view user',6,'view_boardinghouseuser'),(33,'Can add room',9,'add_room'),(34,'Can change room',9,'change_room'),(35,'Can delete room',9,'delete_room'),(36,'Can view room',9,'view_room'),(37,'Can add room transfer history',10,'add_roomtransferhistory'),(38,'Can change room transfer history',10,'change_roomtransferhistory'),(39,'Can delete room transfer history',10,'delete_roomtransferhistory'),(40,'Can view room transfer history',10,'view_roomtransferhistory');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(2,'auth','group'),(3,'auth','permission'),(4,'contenttypes','contenttype'),(6,'Payment_Scheduler','boardinghouseuser'),(7,'Payment_Scheduler','customer'),(8,'Payment_Scheduler','payment'),(9,'Payment_Scheduler','room'),(10,'Payment_Scheduler','roomtransferhistory'),(5,'sessions','session');
...
INSERT INTO `payment_scheduler_customer` VALUES (58,'Bryant','gensan','Active',24,'2025-12-29',NULL,'2025-12-29','09817836641','09122858430','Doris');
...
INSERT INTO `payment_scheduler_payment` VALUES (6,'2025-12-29','2025-12-29',1500.00,'advance payment',1,58,1500.00,0.00,'2025-12-29');
...
INSERT INTO `payment_scheduler_room` VALUES (24,'1','2025-12-29','Occupied','Bed Spacer',1500.00,3,NULL),(25,'2','2025-12-29','Available','Single',2500.00,1,NULL);
/*!40000 ALTER TABLE `payment_scheduler_room` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `payment_scheduler_roomtransferhistory`
--

DROP TABLE IF EXISTS `payment_scheduler_roomtransferhistory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `payment_scheduler_roomtransferhistory` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `room_from_price` decimal(10,2) DEFAULT NULL,
  `room_to_price` decimal(10,2) DEFAULT NULL,
  `transfer_date` datetime(6) NOT NULL,
  `customer_id` int NOT NULL,
  `room_from_id` bigint DEFAULT NULL,
  `room_to_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `Payment_Scheduler_ro_customer_id_8977c06a_fk_Payment_S` (`customer_id`),
  KEY `Payment_Scheduler_ro_room_from_id_58e89af2_fk_Payment_S` (`room_from_id`),
  KEY `Payment_Scheduler_ro_room_to_id_440e4fd8_fk_Payment_S` (`room_to_id`),
  CONSTRAINT `Payment_Scheduler_ro_customer_id_8977c06a_fk_Payment_S` FOREIGN KEY (`customer_id`) REFERENCES `payment_scheduler_customer` (`customer_id`),
  CONSTRAINT `Payment_Scheduler_ro_room_from_id_58e89af2_fk_Payment_S` FOREIGN KEY (`room_from_id`) REFERENCES `payment_scheduler_room` (`id`),
  CONSTRAINT `Payment_Scheduler_ro_room_to_id_440e4fd8_fk_Payment_S` FOREIGN KEY (`room_to_id`) REFERENCES `payment_scheduler_room` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `payment_scheduler_roomtransferhistory`
--

LOCK TABLES `payment_scheduler_roomtransferhistory` WRITE;
/*!40000 ALTER TABLE `payment_scheduler_roomtransferhistory` DISABLE KEYS */;
INSERT INTO `payment_scheduler_roomtransferhistory` VALUES (1,2500.00,1500.00,'2025-12-29 00:15:25.452036',58,25,24);
/*!40000 ALTER TABLE `payment_scheduler_roomtransferhistory` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-12-29  8:23:57
